...
/*
  ...
  References: https://ui.shadcn.com/docs/components/input
*/
...
function Input({ className, type, ...props }) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        // Shared input styling for text fields, file inputs, disabled states,
        // focus rings, invalid states, and dark mode.

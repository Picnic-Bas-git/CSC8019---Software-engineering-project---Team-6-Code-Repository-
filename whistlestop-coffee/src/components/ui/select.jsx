...
/*
  This file defines reusable Select (dropdown) components.

  References: https://ui.shadcn.com/docs/components/radix/select
https://www.radix-ui.com/primitives/docs/components/select

*/
function Select({ ...props }) {
  // Root component that controls the select state (open/closed, value)
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <SelectPrimitive.Viewport
          ...
          className={cn(
            // Ensures dropdown width matches trigger when using popper positioning
...
function SelectScrollUpButton({ className, ...props }) {
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        // Scroll button for long dropdown lists

...
/*
  This file defines reusable Tabs components.

  References: https://www.radix-ui.com/primitives/docs/components/tabs
...
/**
 *  Defines tab list style variants.
 */
...
function TabsTrigger({ className, ...props }) {
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // Clickable tab button handles different states
...
function TabsContent({ className, ...props }) {
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        // Panel area shown for the active tab.
